...
Medicaid waiver programs allow states to provide home and community-based services as an alternative to institutional care. In Georgia, these programs help people stay in their homes rather than being placed in hospitals, nursing facilities, or other institutions.

The word "waiver" refers to the fact that these programs waive certain Medicaid requirements to allow states more flexibility in how they deliver services. The result is a range of programs tailored to different populations and needs.
...
- **Georgia Medicaid enrollment** — The individual must be an active Medicaid member
