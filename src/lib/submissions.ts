...
// Clarification / correction flag types and predicates live in
// clarificationShared.ts (Firebase-free, so the server fan-out and unit tests
// share them); re-exported here so existing importers keep working.
export {
