  ...
  const systemAssessments = [
    ...
    },
    {
      ...
      fields: [
        ...
        { label: 'Feeding Tube Present', key: 'q33_gtubePresent' },
        { label: 'Tube Site Appearance', key: 'q33_gtubeSiteAppearance' },
        { label: 'Tube Site Notes', key: 'q33_gtubeSiteNotes' },
        { label: 'Tube Type', key: 'q33_tubeType' },
        { label: 'Tube Care Performed', key: 'q33_tubeCare' },
        { label: 'Feeding Given', key: 'q33_feedingGiven' },
        { label: 'Feeding Method', key: 'q33_feedingMethod' },
        { label: 'Formula / Feed', key: 'q33_formula' },
        { label: 'Volume / Rate', key: 'q33_feedVolume' },
        { label: 'Water Flush (mL)', key: 'q33_flushVolume' },
        { label: 'HOB Elevated ≥30°', key: 'q33_hobElevated' },
        { label: 'Gastric Residual (mL)', key: 'q33_residualVolume' },
        { label: 'Feeding Tolerance', key: 'q33_feedTolerance' },
        { label: 'Tube Care / Feeding Notes', key: 'q33_tubeFeedingNotes' },
    ...
    <div style={containerStyle}>
      ...
      {cosignModalOpen && (() => {
        ...
        const summary: SubmissionSummary = {
          ...
          dateISO: data.q6_dateofService || '',
          patientId: (data as Record<string, string>).patientId || '',
          shiftStart: data.q7_shiftStart || '',
          shiftEnd: data.q62_shiftEndTime || '',
          shiftEndDate: data.q62_shiftEndDate || '',
          totalHours: data.q9_totalHours || '',
          submittedAt: null,
          status: 'submitted',
          archivedAt: null,
