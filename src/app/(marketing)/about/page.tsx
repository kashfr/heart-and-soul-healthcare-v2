  ...
  return (
    <div className={styles.aboutPage}>
      ...
      <section className={`section ${styles.missionSection}`}>
        <div className="container">
          <StaggerContainer className={styles.missionGrid} staggerDelay={0.15}>
      ...
      <section className={`section bg-light ${styles.storySection}`}>
        <div className="container">
          <div className={styles.storyGrid}>
            ...
            <ScrollReveal direction="right" delay={0.15} className={styles.storyContent}>
      ...
      <section className={`section ${styles.valuesSection}`}>
        <div className="container">
          ...
          <StaggerContainer className={styles.valuesGrid} staggerDelay={0.1}>
            {values.map((value, index) => (
              <StaggerItem key={index} className={styles.valueCard}>
      ...
      <section className={`section bg-primary ${styles.credentialsSection}`}>
        <div className="container">
          <div className={styles.credentialsGrid}>
            ...
            <StaggerContainer className={styles.credentialsList} staggerDelay={0.08}>
              {credentials.map((credential, index) => (
                <StaggerItem key={index} className={styles.credentialItem}>
                  <CheckCircle size={20} />
